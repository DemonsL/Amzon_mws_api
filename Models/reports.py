...
class AprFBAInventoryHealth(Base):
    ...
    def __init__(self, Country, json_report):
        ...
        self.DOS7 = json_report.get('weeks-of-cover-t7')
        self.DOS30 = json_report.get('weeks-of-cover-t30')
        self.DOS90 = json_report.get('weeks-of-cover-t90')
        self.DOS180 = json_report.get('weeks-of-cover-t180')
        self.DOS365 = json_report.get('weeks-of-cover-t365')
        ...
        self.RemovalUnit = json_report.get('qty-with-removals-in-progress')
